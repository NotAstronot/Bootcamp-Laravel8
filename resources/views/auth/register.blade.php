    ...
    <div class="min-h-screen">
        ...
        <div class="px-4 lg:px-[91px] pt-10">
            ...
            <div class="mt-12">
                ...
                <label class="block">
                    <input
                        for="password-confirmation" type="password"" id="password-confirmation"" name="password-confirmation""
                        class="block w-full rounded-full py-4 text-[#1E2B4F] font-medium placeholder:text-[#AFAEC3] placeholder:font-normal px-7 border border-[#d4d4d4] focus:outline-none focus:border-[#0D63F3]"
                        placeholder="Confirmation Password" value="{{ old('password') }}" required autofocus/>
                        
                        @if ($errors->has('password-confirmation'))
                        <p class="text-red mb-3 text-sm">{{ $errors->first('password-confirmation') }}</p>
                        @endif
                </label>
