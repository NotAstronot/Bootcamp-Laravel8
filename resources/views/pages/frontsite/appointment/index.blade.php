    ...
    <div class="min-h-screen">
            ...
            <div class="lg:w-5/12 lg:border-r h-72 lg:h-[30rem] flex flex-col items-center justify-center text-center" >
                ...
                <div class="lg:w-1/3 mt-10 lg:mt-0">
                    <h2 class="text-[#1E2B4F] text-3xl font-semibold leading-normal"> Apply for <br /> New Appointment </h2>
                    ...
                    <form action="" class="mt-8 space-y-5">
                        <label class="block">
                            <select
                                ...
                                <option disabled selected class="hidden"> Topik Konsultasi </option>

                                <option value="Jantung Sesak"> Jantung Sesak </option>

                                <option value="Tekanan Darah Tinggi"> Tekanan Darah Tinggi </option>

                                <option value="Gangguan Irama Jantung"> Gangguan Irama Jantung </option>
                        ...
                        <label class="relative block">
                            <input
                                ...
                                <span class="absolute top-0 right-[11px] bottom-1/2 translate-y-[58%]"><svg
                                        width="24"
                                        height="24"
                                        viewBox="0 0 24 24"
                                        fill="none"
